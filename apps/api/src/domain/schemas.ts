...
export const ProviderSchema = z
  .object({
    ...
    logo_url: z
      .string()
      .nullable()
      .openapi({ example: "https://example.com/logos/venue-a.svg" }),
  })
  .openapi("Provider");
...
export const PlanSchema = z
  .object({
    ...
    description: z
      .string()
      .openapi({ example: "Premium package with seating and food options" }),
...
export const EstimatePlanSchema = z
  .object({
    id: z.string().openapi({ example: "plan_a_premium" }),
    name: z.string().openapi({ example: "Venue A - Premium" }),
  })
...
export const FinaliseEstimateResponseSchema = z
  .object({
    id: z.string().openapi({ example: "est_demo" }),
...
export const ErrorSchema = z
  .object({
    error: z.object({
      ...
      message: z
        .string()
        .openapi({ example: "Missing required field: seating_type" }),
    }),
  })
  .openapi("Error");
